    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_caption', models.CharField(default='Image caption.', max_length=100)),
                ('slug', models.SlugField(max_length=250, unique_for_date='publish')),
                ('content', models.TextField()),
                ('status', models.CharField(choices=[('draft', 'Draft'), ('published', 'Published')], default='draft', max_length=10)),
                ('like_count', models.BigIntegerField(default='0')),
                ('large_feature', models.BooleanField(help_text='Select to display as the large featured post')),
                ('small_feature_1', models.BooleanField(help_text='Select to display as one of the smaller featured post')),
                ('small_feature_2', models.BooleanField(help_text='Select to display as one of the smaller featured post')),
